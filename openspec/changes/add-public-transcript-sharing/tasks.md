...
- [ ] 3.1 Add automated coverage for share enable, disable, rotate, double-UUID link resolution, and private-library shared/unshared sort and filter behavior.
- [ ] 3.2 Add automated coverage for privacy-minimal public rendering and generic unavailable behavior for invalid links.
